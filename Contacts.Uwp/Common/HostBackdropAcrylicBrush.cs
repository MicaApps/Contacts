...
namespace Contacts.Uwp.Common
{
    public sealed class HostBackdropAcrylicBrush : XamlCompositionBrushBase, IDisposable
    {
        ...
        public Uri NoiseTextureUri { get; set; } = new Uri("ms-appx:///Assets/NoiseHigh.png");

        private readonly SemaphoreSlim _semaphoreSlim = new SemaphoreSlim(1);

        private readonly UISettings UISettings = new UISettings();

        private const float _acrylicTintOpacityMinThreshold = 0.85f;
